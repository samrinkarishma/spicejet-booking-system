...
public class TC_04_Loginwithmobnumber extends Baseclass {

	@DataProvider(name="login_with_mobilenumber")
	public Object[][] getlogindata() throws EncryptedDocumentException, IOException, InterruptedException
	{
		...
		FileInputStream file=new FileInputStream("C:\\Users\\Dell-2023\\eclipse-workspace\\Booking-system\\src\\test\\java\\testdata\\login_with_mobilenumber.xlsx");
	...
	@Test(dataProvider="login_with_mobilenumber")
	public void LoginWith_mobilenumber(String Mobilenumber,String password) throws InterruptedException{
		Reporter.log("Welcome to loginpage",true);		
		//create an object of loginpage
		Loginpage loginobj=new Loginpage(driver);
		loginobj.loginlinkfield();
		Thread.sleep(3000);
        loginobj.mobilenumber();
		Thread.sleep(3000);
